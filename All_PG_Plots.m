...
figure(1)
hold on
plot(kmlen1, PGV_total{1}, 'o')
plot(kmlen2, PGV_total{2}, 'o')
plot(kmlen3, PGV_total{3}, 'o')
plot(kmlen4, PGV_total{4}, 'o')
plot(kmlen5, PGV_total{5}, 'o')
plot(kmlen6, PGV_total{6}, 'o')
plot(kmlen7, PGV_total{7}, 'o')
plot(kmlen8, PGV_total{8}, 'd')
plot(kmlen10, PGV_total{10}, 'd')
plot(kmlen11, PGV_total{11}, 'd')
plot(kmlen12, PGV_total{12}, 'd')
plot(kmlen13, PGV_total{13}, 'd')
...
figure(2)
hold on 
plot(kmlen1, PGA_total{1}, 'o')
plot(kmlen2, PGA_total{2}, 'o')
plot(kmlen3, PGA_total{3}, 'o')
plot(kmlen4, PGA_total{4}, 'o')
plot(kmlen5, PGA_total{5}, 'o')
plot(kmlen6, PGA_total{6}, 'o')
plot(kmlen7, PGA_total{7}, 'd')
plot(kmlen8, PGA_total{8}, 'd')
plot(kmlen10, PGA_total{10}, 'd')
plot(kmlen11, PGA_total{11}, 'd')
plot(kmlen12, PGA_total{12}, 'd')
plot(kmlen13, PGA_total{13}, 'd')
