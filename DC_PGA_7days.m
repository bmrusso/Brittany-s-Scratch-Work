...
dblecount = find(totsubtract19 > 0 | totsubtract19 < 0);
totsubtract19(25) = 0;
totsubtract19(26) = 0;
totsubtract19(29) = 0;
totsubtract19(30) = 0;
...
dblecount = find(totsubtract15 > 0 | totsubtract15 < 0);
totsubtract15(4) = 0;
...
stem(m7date6(rateaft)+7, ma6(rateaft), 'c-')
stem(m7date6(rateaft)-7, ma6(rateaft), 'c-')

stem(m7date6(ratebef)+7, ma6(ratebef), 'm-')
stem(m7date6(ratebef)-7, ma6(ratebef), 'm-')
