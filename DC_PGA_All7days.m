...
m_before = find(all_before{2}{9} > 0);
m_after = find(all_after{2}{9} >0);
all_subtract{3}{9}(8) = 0;
all_subtract{3}{9}(9) = 0;
all_subtract{3}{9}(12) = 0;
all_subtract{3}{9}(13) = 0;
all_subtract{3}{9}(18) = 0;
all_subtract{2}{9}(7) = 0;
all_subtract{2}{9}(10) = 0;
