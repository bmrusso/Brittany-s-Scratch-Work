...
% has been account for, for the 3 day period against the date of the 
% teleseisms.
...
datetick('x', 1)
legend('Dagger')
title('Cumulative Sum Plot - 3 Days')
hold off
