...
totsubtract{1}(dblecount(end-1:end)) = 0;

fixbewt7 = totsubtract{1}; % Corrected for double counting
...
fixcog7 = totsubtract{2}; % Corrected for double counting
...
fixdagger7 = totsubtract{3}; % Corrected for double counting
...
fixfash7 = totsubtract{4}; % Corrected for double counting
...
fixncentark7 = totsubtract{5}; % Corrected for double counting
...
fixgreeley7 = totsubtract{6}; % Corrected for double counting
...
fixirving7 = totsubtract{7}; % Corrected for double counting
...
fixntx7 = totsubtract{8}; % Corrected for double counting
...
fixvenus7 = totsubtract{14}; % Corrected for double counting
...
fixokks7 = totsubtract{9}; % Corrected for double counting
...
fixparadox7 = totsubtract{10}; % Corrected for double counting
...
totsubtract{11}(47) = 0;
totsubtract{11}(127) = 0;
totsubtract{11}(128) = 0;
totsubtract{11}(137) = 0;
totsubtract{11}(159) = 0;
totsubtract{11}(160) = 0;
totsubtract{11}(161) = 0;
totsubtract{11}(167) = 0;
totsubtract{11}(189) = 0;
totsubtract{11}(197) = 0;
totsubtract{11}(212) = -1;
totsubtract{11}(215) = 0;

fixraton7 = totsubtract{11}; % Corrected for double counting
...
fixsuncity7 = totsubtract{12}; % Corrected for double counting
...
fixtimp7 = totsubtract{13}; % Corrected for double counting
...
fixyoungs7 = totsubtract{15}; % Corrected for double counting
