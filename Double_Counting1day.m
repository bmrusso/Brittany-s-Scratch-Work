...
fixbewt1 = totsubtract{1}; % Corrected for double counting
...
fixcog1 = totsubtract{2}; % Corrected for double counting
...
fixdagger1 = totsubtract{3}; % Corrected for double counting
...
fixfash1 = totsubtract{4}; % Corrected for double counting
...
fixncentark1 = totsubtract{5}; % Corrected for double counting
...
fixgreeley1 = totsubtract{6}; % Corrected for double counting
...
fixirving1 = totsubtract{7}; % Corrected for double counting
...
fixntx1 = totsubtract{8}; % Corrected for double counting
...
fixvenus1 = totsubtract{14}; % Corrected for double counting
...
fixokks1 = totsubtract{9}; % Corrected for double counting
...
fixparadox1 = totsubtract{10}; % Corrected for double counting
...
fixraton1 = totsubtract{11}; % Corrected for double counting
...
fixsuncity1 = totsubtract{12}; % Corrected for double counting
...
fixtimp1 = totsubtract{13}; % Corrected for double counting
...
fixyoungs1 = totsubtract{15}; % Corrected for double counting
