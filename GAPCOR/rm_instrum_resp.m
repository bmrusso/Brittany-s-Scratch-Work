...
% Original 4/22/2012
% Updated  5/01/2013
%          Lines 188-193 have been modified to avoid inf output from freqz 
%          at all possible frequencies instead of just at zero frequency.
%          Thanks to Mark Jellinek for discovering this bug.
%          Also, the hanning taper is applied at the start of the data 
%          instead of both start and end since the filter is causal.  
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% input arguments
%
...
% NOTES: 
% 
% 1. A hanning taper is applied to the start of the raw seismogram
% prior to instrument correction. The length of the taper is specified
% at line 93. It is the smaller of the following two values: 10
...
tpr2 = [tpr(1:(tlen/2)) ones(1,(length(rawdata)-(tlen/2))) ];
% pad the data
