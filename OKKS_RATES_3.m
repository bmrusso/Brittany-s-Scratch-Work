...
plot(datevector2, cumsum(eq3))
legend('Number of Earthquakes per 3 Days', 'Cumulative Sum of Earthquakes')
datetick('x', 1)
title('Cumulative Sum vs. the Number of Earthquakes per 3 Day')
xlabel('Date')
