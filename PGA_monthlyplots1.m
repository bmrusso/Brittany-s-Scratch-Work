...
title('Cumulative Sum vs Earthquake Rate - Threshold 2.4x10^-^-3')
...
ylabel('Number of Earthquakes')
plot(monthly_data{1}{2}, monthly_data{1}{1})
title('Cumulative Sum vs Earthquake Rate - Threshold 1.0x10^-^3')
...
ylabel('Number of Earthquakes')
plot(monthly_data{1}{2}, monthly_data{1}{1})
title('Cumulative Sum vs Earthquake Rate - Threshold 4.5x10^-^4')
legend('Cumulative Sum','Teleseism','Monthly EQ Rate','Location','NorthWest')
datetick('x',2)
xlabel('Date')
hold off
